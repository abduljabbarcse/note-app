...
import { closeModal, updateCurrentNoteField } from "@/lib/features/modalSlice";
import {
  createNoteAsync,
  deleteNoteAsync,
  updateNoteAsync,
...
const NoteModal = () => {
  ...
  const { isOpen, isEdit, currentNote } = useAppSelector(
    (state) => state.modal
  );
        ...
        >
          ...
          >
            ...
            <div className={styles.actions}>
              ...
              {isEdit ? (
                <button
                  className={`font-poppins ${styles.deleteBtn}`}
                ...
                <button
                  className={`font-poppins ${styles.cancelBtn}`}
                  onClick={() => dispatch(closeModal())}
                >
                  Cancel
                </button>
